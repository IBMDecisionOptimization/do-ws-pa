...
inputs = {};
outputs = {};
inputs["Geo"] = pd.read_csv("Geo.csv")
inputs["Competitors"] = pd.read_csv("Competitors.csv")
inputs["GeoToCompetitorPerformance"] = pd.read_csv("GeoToCompetitorPerformance.csv")
inputs["CompetitiveRating"] = pd.read_csv("CompetitiveRating.csv")
inputs["Parameter"] = pd.read_csv("Parameter.csv")
inputs["Store"] = pd.read_csv("Store.csv")
inputs["GeoToStorePerformance"] = pd.read_csv("GeoToStorePerformance.csv")
